...
1. **Relatório PDF:** Finalizado para leitura, em `./output/[numero_oportunidade]_analise_contratual.pdf`.
2. **Relatório TXT:** Dados brutos para comparação, em `./output/[numero_oportunidade]_analise_contratual.txt`.
3. **Relatório HTML:** Finalizado para leitura, em `./output/[numero_oportunidade]_analise_contratual.html`.

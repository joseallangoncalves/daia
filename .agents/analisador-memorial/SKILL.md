...
1. **Relatório PDF:** Finalizado para leitura, em `./output/[numero_oportunidade]_analise_memorial.pdf`.
2. **Relatório TXT:** Dados brutos para comparação, em `./output/[numero_oportunidade]_analise_memorial.txt`.
3. **Relatório HTML:** Dados estruturados para visualização, em `./output/[numero_oportunidade]_analise_memorial.html`.
